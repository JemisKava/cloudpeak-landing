  ...
  return (
    <div className="mt-6 space-y-4 p-4">
      {features.map((feature, index) => (
        <div key={index} className="flex items-center gap-4 rounded-lg p-4 shadow-md bg-[#1a243d] sm:flex-col sm:items-start">
          ...
          <div className="text-start  space-y-1">
            <h3 className="text-body-14 font-medium text-neutral-1">{feature.title}</h3>
