...
export const PricingPlanCard: PricingPlanCardComponent = ({ children, className }) => {
  return <div className={`p-8 flex flex-col gap-10 ${className}`}>{children}</div>;
};
...
PricingPlanCard.Button = ({ text }) => (
  <button className='py-4 px-6 rounded-[90px] bg-primary text-neutral-1 text-body-16 w-6/12 md:w-full'>
    {text}
  </button>
);
