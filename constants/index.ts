...
export const PLANS: PlanData[] = [
  {
    ...
    yearlyPrice: "$190",
    features: [
      { icon: CHECKMARK_ICON, text: "Comprehensive Dashboard" },
      { icon: CHECKMARK_ICON, text: "Advanced Analytics" },
      { icon: CHECKMARK_ICON, text: "User Management" },
      { icon: CHECKMARK_ICON, text: "Custom Branding" },
      { icon: CHECKMARK_ICON, text: "Priority Support" },
    ],
